...
export default function ModalAddress(prop){
    ...
    <div className ="form">
        ...
        <div class="form-group">
            <input type="text" class="form-control input4 shadow-none" placeholder="House No."/>
        </div>
        <div class="form-group">
            <input type="text" class="form-control input4 shadow-none" placeholder="St. Block"/>
        </div>
        <div class="form-group">
            <select class="form-select input4 shadow-none"  placeholder="NGO" name="ngo"> 
